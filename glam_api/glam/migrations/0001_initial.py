# Generated by Django 3.2.15 on 2022-12-08 19:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_data', models.FileField(blank=True, help_text='Original Boundary Layer raster or vector', null=True, storage=config.storage_backends.RasterStorage(), upload_to='regions')),
                ('vector_file', models.FileField(blank=True, help_text='Vector geometry file for visual representation in the GLAM application', null=True, storage=config.storage_backends.VectorStorage(), upload_to='vectors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_path', models.FilePathField(help_text='Path to dataset on current machine. Used to upload dataset file_object.', match='.*\\.tif$', path='/data/glam2/api/glam_api/local_files/boundary_datasets', recursive=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boundary_dataset', models.ForeignKey(help_text='Boundary Layer dataset of ZonalStats.', on_delete=django.db.models.deletion.CASCADE, to='glam.boundaryraster')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['product_dataset', 'mask_dataset', 'boundary_dataset', 'feature_id', 'date'], name='zstats_idx'),
        ),
        migrations.AddIndex(
            model_name='zonalstats',
            index=models.Index(fields=['product_dataset', 'mask_dataset', 'boundary_dataset', 'feature_id'], name='zstats_idx_no_date'),
        ),
        migrations.AddIndex(
