...
from ..models import ProductRaster, BoundaryLayer, BoundaryFeature, ImageExport
...
def image_export(export_id, data):
    ...
    if geom:
        ...
        geom = shape(json.loads(boundary_feature.geom.geojson))

    with rasterio.open(path) as src:
        product_crs = src.crs
        wgs84 = pyproj.CRS("EPSG:4326")
        project = pyproj.Transformer.from_crs(
            wgs84, product_crs, always_xy=True
        ).transform
