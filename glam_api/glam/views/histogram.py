...
from rest_pandas.renderers import (
    PandasCSVRenderer,
    PandasExcelRenderer,
    PandasJSONRenderer,
    PandasTextRenderer,
...
class Histogram(PandasViewSet):
    ...
    resp_200 = openapi.Response(
        ...
        examples={
            "application/json": {
                "date": "2021-01-01",
                "hist": [3, 6, 15, 21, 22, 23, 25, 32, 34, 35, 41, 42, 52, 54, 55],
                "bin_edges": [
                    0,
                    10,
                    20,
    ...
    def custom_feature_histogram(self, request):
        ...
        if request.method == "POST":
            ...
            product_queryset = ProductRaster.objects.filter(product=product)
